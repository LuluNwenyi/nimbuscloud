...
6. And that’s it! You’re done.
  ...
  2. After uploading your file to NimbusCloud, you can also use the [`ListFile` endpoint](/nimbuscloud/api-reference#tag/nimbusstore) to retrieve objects from the NimbusStore, and the [`DeleteFile` endpoint](/nimbuscloud//api-reference#tag/nimbusstore) to delete objects you no longer need from NimbusStore.
  :::
